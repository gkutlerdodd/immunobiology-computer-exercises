...
In this computer practical, you will investigate this question using bioinformatics tools. You will first learn how to use the **Immune Epitope Database (IEDB)** to identify experimentally validated coronavirus epitopes shown to elicit a T-cell response. You will then use **NetMHCpan** to predict peptide-HLA binding and investigate whether other HLA alleles can present cross-reactive epitopes.
